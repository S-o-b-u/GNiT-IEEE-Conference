          ...
          {isLoading ? (
            ...
            <div className="space-y-8">
              <Alert>
                ...
                <AlertDescription>
                  Please ensure your paper follows all formatting guidelines and
                  is prepared using the official conference template before
                  submission.
                </AlertDescription>
              </Alert>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-primary/5 border border-primary/20 rounded-lg p-6 text-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                      All submissions are handled through our online submission
                      system
                    </p>
                    <Button
                      size="lg"
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    All submissions will undergo a rigorous double-blind peer
                    review process. Each paper will be reviewed by at least two
                    experts in the field. Authors will be notified of the review
                    decision via email. Accepted papers must be revised
                    according to reviewers' comments and submitted in
                    camera-ready format by the specified deadline.
                  </p>
                </CardContent>
              </Card>
            </div>
