...
import type { ContactPerson } from "@/lib/db/schema";
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p
                                ...
                                data-testid={`text-contact-designation-${contact.id}`}
                              >
                                {contact.designation}
                              </p>
                            </div>
                          ...
                          {contact.department && (
                            <p
                              ...
                              data-testid={`text-contact-department-${contact.id}`}
                            >
                              {contact.department}
                            </p>
                          )}
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  For general questions about the conference, paper submissions,
                  or registration, please feel free to reach out to any of the
                  contact persons listed above. We aim to respond to all
